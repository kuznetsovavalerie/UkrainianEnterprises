...
namespace UkrainianEnterprises.Identity
{
        ...
        IUserStore<IdentityUser, Guid>, IDisposable
    {
        ...
        public Task CreateAsync(IdentityUser user)
        {
            ...
            _unitOfWork.UserManager.Create(u);
        ...
        public Task DeleteAsync(IdentityUser user)
        {
            ...
            _unitOfWork.UserManager.Delete(u);
            return _unitOfWork.SaveChangesAsync();
        }

        public Task<IdentityUser> FindByIdAsync(Guid userId)
        {
            var user = _unitOfWork.UserManager.GetByID(userId);
            return Task.FromResult<IdentityUser>(getIdentityUser(user));
        }

        public Task<IdentityUser> FindByNameAsync(string userName)
        {
            var user = _unitOfWork.UserManager.FindByUserName(userName);
            return Task.FromResult<IdentityUser>(getIdentityUser(user));
        }
        ...
        public Task UpdateAsync(IdentityUser user)
        {
            ...
            var u = _unitOfWork.UserManager.GetByID(user.Id);
            if (u == null)
                throw new ArgumentException("IdentityUser does not correspond to a User entity.", "user");

            populateUser(u, user);

            _unitOfWork.UserManager.Update(u);
            return _unitOfWork.SaveChangesAsync();
        }
        #endregion
        ...
        public Task<IdentityUser> FindAsync(UserLoginInfo login)
        {
            ...
            var l = _unitOfWork.LoginManager.GetByProviderAndKey(login.LoginProvider, login.ProviderKey);
            if (l != null)
        ...
        public Task AddToRoleAsync(IdentityUser user, string roleName)
        {
            ...
            if (u == null)
                throw new ArgumentException("IdentityUser does not correspond to a User entity.", "user");
            var r = _unitOfWork.RoleManager.FindByName(roleName);
            if (r == null)
